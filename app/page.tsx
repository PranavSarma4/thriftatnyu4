...
export default function Home() {
  return (
    <div className="overflow-hidden">
      ...
      {/* Stats Section */}
      <section className="py-20 border-y-2 border-[var(--border)]">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-[var(--surface)] p-8 border-2 border-[var(--border)] card-hover h-full">
                  <div className="text-6xl font-bold text-[var(--muted)] mb-4">
                    {String(index + 1).padStart(2, '0')}
                  </div>
                  <div className="w-12 h-12 bg-[var(--foreground)] flex items-center justify-center mb-4">
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-[var(--foreground)] text-[var(--background)] p-8"
            >
              <div className="text-sm uppercase tracking-wider mb-2 opacity-60">
                Average Seller Earnings
              </div>
              <div className="text-6xl font-bold mb-6">$127</div>
              
              <div className="space-y-4 text-sm">
                <div className="flex justify-between border-t border-[var(--background)]/20 pt-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-[var(--surface)] p-8 border-2 border-[var(--border)] card-hover"
              >
